package org.firstinspires.ftc.teamcode.opmodes.RoverRuckusTesting;
...
import org.firstinspires.ftc.teamcode.Lib.RoverRuckusTestLib.RoverRuckusDemoRobot;
...
public class TestLiftWithTeleop extends LinearOpMode {
    ...
    DriveTrainMode driveTrainMode = TestLiftWithTeleop.DriveTrainMode.TANK_DRIVE;

    public RoverRuckusDemoRobot robot;
...
//            }
            ...
            if (driveTrainMode == TestLiftWithTeleop.DriveTrainMode.TANK_DRIVE) {
            ...
            telemetry.addData("lift Motor Speed = ", "%3.2f", robot.liftMotor.getCurrentPower());
    ...
    private void toggleDriveTrainMode() {
        if (driveTrainMode == TestLiftWithTeleop.DriveTrainMode.DIFFERENTIAL_DRIVE) {
            driveTrainMode = TestLiftWithTeleop.DriveTrainMode.TANK_DRIVE;
        } else
            driveTrainMode = TestLiftWithTeleop.DriveTrainMode.DIFFERENTIAL_DRIVE;
    }
