...
public class AdafruitBackpackLEDTestCompile extends I2cDeviceSynchDevice<I2cDeviceSynch> {
...
//    LEDCode ledCode;
    ...
    public AdafruitBackpackLEDTestCompile(I2cDeviceSynch deviceClient) {
