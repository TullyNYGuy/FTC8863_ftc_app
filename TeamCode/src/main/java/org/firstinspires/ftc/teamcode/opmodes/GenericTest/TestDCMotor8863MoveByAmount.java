 ...
 */
@TeleOp(name = "Test DcMotor8863 Move By Amount", group = "Test")
//@Disabled
public class TestDCMotor8863MoveByAmount extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // When the motor was initialized, the encoder was set to 0. Relative movements are always
            // done relative to that the current position. Think of these types of commands as:
            // Move from where you are now by a given amount
            ...
            motor.moveByAmount(powerToRunAt, 1440, DcMotor8863.FinishBehavior.HOLD);
