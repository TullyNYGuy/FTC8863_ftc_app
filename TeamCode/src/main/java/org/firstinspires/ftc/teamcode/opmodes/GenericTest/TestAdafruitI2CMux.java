...
public class TestAdafruitI2CMux extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        colorSensor1 = new AdafruitColorSensor(colorSensorName, coreDIMName, hardwareMap, CHANNEL_FOR_LED);

        // Note that there are 2 color sensor objects. But the phone and hardware map only know about
        // one. That is because you are switching between them using the mux. I probably could get
        // away with only 1 color sensor object but since I need to initialize both color sensors
        ...
        colorSensor2 = new AdafruitColorSensor(colorSensorName, coreDIMName, hardwareMap, CHANNEL_FOR_LED);
        ...
        while(opModeIsActive()) {
            ...
            telemetry.addData("Active Port = ", activePort);
