...
@TeleOp(name = "Relic Recovery Teleop", group = "Run")
//@Disabled
...
//            }
            ...
            if (driveTrainMode == RelicRecoveryTeleop.DriveTrainMode.TANK_DRIVE) {
    ...
    private void toggleDriveTrainMode() {
        if (driveTrainMode == RelicRecoveryTeleop.DriveTrainMode.DIFFERENTIAL_DRIVE) {
            driveTrainMode = RelicRecoveryTeleop.DriveTrainMode.TANK_DRIVE;
        } else
