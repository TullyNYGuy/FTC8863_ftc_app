...
@TeleOp(name = "WonderWorksDemo2", group = "Run")
//@Disabled

public class WonderWorksDemo2 extends LinearOpMode {
    ...
    DriveTrainMode driveTrainMode = WonderWorksDemo2.DriveTrainMode.TANK_DRIVE;
...
//            }
            ...
            if (driveTrainMode == WonderWorksDemo2.DriveTrainMode.TANK_DRIVE) {
    ...
    private void toggleDriveTrainMode() {
        if (driveTrainMode == WonderWorksDemo2.DriveTrainMode.DIFFERENTIAL_DRIVE) {
            driveTrainMode = WonderWorksDemo2.DriveTrainMode.TANK_DRIVE;
        } else
            driveTrainMode = WonderWorksDemo2.DriveTrainMode.DIFFERENTIAL_DRIVE;
    }
