 ...
 *
 */
@Autonomous(name = "Blue Mat No Jewel", group = "Run")
//@Disabled
public class BlueMatNoJewel extends AutonomousMethods {

    // Put your variable declarations here
    StartPosition startPosition = StartPosition.NEAR_MAT;
    AllianceColor.TeamColor teamColor = AllianceColor.TeamColor.BLUE;
