package org.firstinspires.ftc.teamcode.opmodes.RoverRucus;
...
@TeleOp(name = "Collection Delivery Test Teleop", group = "Run")
//@Disabled

public class CollectionDeliveryTestTeleop extends LinearOpMode {
...
//            }
            ...
            if (driveTrainMode == CollectionDeliveryTestTeleop.DriveTrainMode.TANK_DRIVE) {
    ...
    private void toggleDriveTrainMode() {
        if (driveTrainMode == CollectionDeliveryTestTeleop.DriveTrainMode.DIFFERENTIAL_DRIVE) {
            driveTrainMode = CollectionDeliveryTestTeleop.DriveTrainMode.TANK_DRIVE;
        } else
            driveTrainMode = CollectionDeliveryTestTeleop.DriveTrainMode.DIFFERENTIAL_DRIVE;
    }
