...
@TeleOp(name = "WonderWorkDemo", group = "Run")
//@Disabled

public class WonderWorkDemo extends LinearOpMode {
    ...
    DriveTrainMode driveTrainMode = WonderWorkDemo.DriveTrainMode.TANK_DRIVE;

    public WonderWorkDemoRobot robot;
...
//            }
            ...
            if (driveTrainMode == WonderWorkDemo.DriveTrainMode.TANK_DRIVE) {
    ...
    private void toggleDriveTrainMode() {
        if (driveTrainMode == WonderWorkDemo.DriveTrainMode.DIFFERENTIAL_DRIVE) {
            driveTrainMode = WonderWorkDemo.DriveTrainMode.TANK_DRIVE;
        } else
            driveTrainMode = WonderWorkDemo.DriveTrainMode.DIFFERENTIAL_DRIVE;
    }
