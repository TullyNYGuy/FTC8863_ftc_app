 ...
 */
@Autonomous(name = "Blue No Mat Column 2", group = "Run")
@Disabled
public class BlueNonMatColumn2 extends LinearOpMode {
    ...
    public void createRobot() {
        ...
        telemetry.update();
        robot = robot.createRobotForAutonomous(hardwareMap, telemetry, AllianceColor.TeamColor.BLUE, dataLog);
    }
